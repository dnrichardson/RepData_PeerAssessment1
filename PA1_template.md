...
Now, let's create a histogram of the total number of steps taken each day. We will use ggplot2. 
...
totStepsByDay <- tapply(activity2$steps, activity2$date, sum, na.rm=TRUE)
